                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'hlz9rlei' /* Driver Reference: DRV-28-1381-... */,
                                        ),
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MAIN_MESSAGES_Container_trrbyy5l_ON_TAP');
                                          await action_blocks
                                          ...
                                          Padding(
                                            ...
                                            child: StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<UsersRecord>
                                                    listmessageswebUsersRecordList =
                                                    snapshot.data!;
                                                ...
                                                return Column(
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    final listmessageswebUsersRecord =
                                                        listmessageswebUsersRecordList[
                                                            listmessageswebIndex];
                                                    return Padding(
                                                      padding:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: SelectionArea(
                                                                                  child: Text(
                                                                                FFLocalizations.of(context).getText(
                                                                                  'it69akbs' /* Hi Tobi, this is Barbara Okoro... */,
                                                                                ),
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child: SelectionArea(
                                                                              child: AutoSizeText(
                                                                            FFLocalizations.of(context).getText(
                                                                              'yny0f2zl' /* Hi Barbara, thank you for reac... */,
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child: SelectionArea(
                                                                              child: AutoSizeText(
                                                                            FFLocalizations.of(context).getText(
                                                                              'wd13pals' /* This is my intro video */,
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
