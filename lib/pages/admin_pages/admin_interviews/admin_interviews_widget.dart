...
class AdminInterviewsWidget extends StatefulWidget {
  const AdminInterviewsWidget({
    super.key,
    this.jobposting,
    this.jobposts,
  });
  ...
  final JobPostingRecord? jobposts;

  static String routeName = 'Admin_Interviews';
  static String routePath = 'adminInterviews';

  @override
  State<AdminInterviewsWidget> createState() => _AdminInterviewsWidgetState();
}

class _AdminInterviewsWidgetState extends State<AdminInterviewsWidget>
    with TickerProviderStateMixin {
  late AdminInterviewsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminInterviewsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Admin_Interviews'});
                              ...
                              builder: (context) => Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'ADMIN_INTERVIEWS_PAGE_bg_color_ON_TAP');
                                                ...
                                                children: [
                                                  if (responsiveVisibility(
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ADMIN_INTERVIEWS_Icon_z20kpp9k_ON_TAP');
                                                        scaffoldKey
                                                            .currentState!
                                                            .openDrawer();
                                                      },
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ADMIN_INTERVIEWS_Icon_jh9bj5nd_ON_TAP');
                                                        await action_blocks
                                                            .opennotifications(
                                                                context);
                                                      },
                                                              ...
                                                              if (responsiveVisibility(
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'ADMIN_INTERVIEWS_Container_zdc13d74_ON_T');
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ADMIN_INTERVIEWS_Icon_3sutcmwm_ON_TAP');
                                          context.safePop();
                                        },
                                        child: Icon(
                                          Icons.arrow_back,
                                          ...
                                          tabs: [
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'z3pnxgky' /* Job Details */,
                                              ),
                                            ),
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                '4j27cfuw' /* Applications */,
                                              ),
                                            ),
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'mw40pdb0' /* Regional Flight Truck Driver */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyLarge
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Flexible(
                                                                                child: Text(
                                                                                  FFLocalizations.of(context).getText(
                                                                                    'u682y0i5' /* Freight Truck (Class A CDL req... */,
                                                                                  ),
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Flexible(
                                                                          child:
                                                                              Text(
                                                                            FFLocalizations.of(context).getText(
                                                                              'qf6vcyf2' /* Monday to Friday: 8AM to 6PM */,
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).labelMedium.override(
                                                                                  fontFamily: 'Aeonik',
                                                                                  letterSpacing: 0.0,
                                                                  ...
                                                                  if (listViewApplicationsRecordList
                                                                    ...
                                                                    return EmptyStateSimpleWidget(
                                                                      ...
                                                                      title: FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        'kkgh8qsg' /* No Applications yet */,
                                                                      ),
                                                                      body: FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        'tlj7bor7' /* Give it some time, they will  ... */,
                                                                      ),
                                                                    );
                                                                  }
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            UsersRecord>(
                                                                          stream:
                                                                              UsersRecord.getDocument(listViewApplicationsRecord.appliedby!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                            ...
                                                                            return InkWell(
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                logFirebaseEvent('ADMIN_INTERVIEWS_Container_ko7zmlk2_ON_T');
                                                                                              ...
                                                                                              child: Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Theme(
                                                                                                    ...
                                                                                                    child: Checkbox(
                                                                                                      value: _model.checkboxValueMap1[listViewApplicationsRecord] ??= false,
                                                                                                      onChanged: (newValue) async {
                                                                                                        safeSetState(() => _model.checkboxValueMap1[listViewApplicationsRecord] = newValue!);
                                                                                                      },
                                                                                                      side: BorderSide(
                                                                                                        width: 2,
                                                                                                        color: FlutterFlowTheme.of(context).alternate,
                                                                                              ...
                                                                                              Container(
                                                                                                ...
                                                                                                child: Padding(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    valueOrDefault<String>(
                                                                                                      '${valueOrDefault<String>(
                                                                                                        containerUsersRecord.experience.toString(),
                                                                                                        '3',
                                                                                                      )} years',
                                                                                                      '- years',
                                                                                                    ),
                                                                                            ...
                                                                                            if (responsiveVisibility(
                                                                                              ...
                                                                                              Container(
                                                                                                ...
                                                                                                child: Padding(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    valueOrDefault<String>(
                                                                                                      listViewApplicationsRecord.interviewTime?.toString(),
                                                                                                      '--:--AM',
                                                                                                    ),
                                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                          fontFamily: 'Aeonik',
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Builder(
                                                                                                      builder: (context) => InkWell(
                                                                                                        ...
                                                                                                        highlightColor: Colors.transparent,
                                                                                                        onTap: () async {
                                                                                                          logFirebaseEvent('ADMIN_INTERVIEWS_Container_mbuxl9il_ON_T');
                                                                                                            ...
                                                                                                            builder: (dialogContext) {
                                                                                                              return Material(
                                                                                                                ...
                                                                                                                child: GestureDetector(
                                                                                                                  ...
                                                                                                                  child: InterviewstatusWidget(
                                                                                                                    application: listViewApplicationsRecord,
                                                                                                                  ),
                                                                                                                ),
                                                                                                              );
                                                                                                            },
                                                                                                        ...
                                                                                                        child: Container(
                                                                                                          ...
                                                                                                          decoration: BoxDecoration(
                                                                                                            color: () {
                                                                                                              if (containerUsersRecord.status == 'Review') {
                                                                                              ...
                                                                                              StreamBuilder<List<ChatsRecord>>(
                                                                                                stream: queryChatsRecord(
                                                                                                  queryBuilder: (chatsRecord) => chatsRecord.where(
                                                                                                    'users',
                                                                                                    arrayContains: containerUsersRecord.reference,
                                                                                                  ),
                                                                                                  singleRecord: true,
                                                                                                ),
                                                                                                builder: (context, snapshot) {
                                                                                                  ...
                                                                                                  return InkWell(
                                                                                                    ...
                                                                                                    highlightColor: Colors.transparent,
                                                                                                    onTap: () async {
                                                                                                      logFirebaseEvent('ADMIN_INTERVIEWS_Container_brnfvn3k_ON_T');
                                                                                                      _model.addToFriendsList(containerUsersRecord.reference);
                                                                                                      safeSetState(() {});
                                                                                                      _model.addToFriendsList(currentUserReference!);
                                                                                                      safeSetState(() {});
                                                                                                      if (_model.friendsList.length >= 2) {
                                                                                                        if (containerChatsRecord?.reference != null) {
                                                                                                          // updateChat

                                                                                                          await containerChatsRecord!.reference.update({
                                                                                                          ...
                                                                                                          // updateChat
                                                                                                          _model.updatedChatThreadint = await queryChatsRecordOnce(
                                                                                                            singleRecord: true,
                                                                                                          ...
                                                                                                          context.pushNamed(
                                                                                                            MainMessagesCopyWidget.routeName,
                                                                                                            queryParameters: {
                                                                                                              'chatRef': serializeParam(
                                                                                                                _model.updatedChatThreadint?.reference,
                                                                                                          ...
                                                                                                          _model.newChatThr = ChatsRecord.getDocumentFromData({
                                                                                                            ...createChatsRecordData(
                                                                                                              userA: currentUserReference,
                                                                                                              userB: containerUsersRecord.reference,
                                                                                                              lastMessage: '',
                                                                                      ...
                                                                                      Builder(
                                                                                        builder: (context) => Padding(
                                                                                          ...
                                                                                          child: InkWell(
                                                                                            ...
                                                                                            highlightColor: Colors.transparent,
                                                                                            onTap: () async {
                                                                                              logFirebaseEvent('ADMIN_INTERVIEWS_Icon_atkbemzp_ON_TAP');
                                                                                              await showAlignedDialog(
                                                                ...
                                                                if (listViewApplicationsRecordList
                                                                  ...
                                                                  return EmptyStateSimpleWidget(
                                                                    ...
                                                                    title: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'z6s7ldi5' /* No Interviews Setup yet */,
                                                                    ),
                                                                    body:
                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return InkWell(
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('ADMIN_INTERVIEWS_Container_89ai7gls_ON_T');
                                                                              await action_blocks.openuserdetails(
                                                                                context,
                                                                                user: containerUsersRecord,
                                                                              );
                                                                                        ...
                                                                                        children: [
                                                                                          Container(
                                                                                            ...
                                                                                            child: StreamBuilder<UsersRecord>(
                                                                                              stream: UsersRecord.getDocument(listViewApplicationsRecord.appliedby!),
                                                                                              builder: (context, snapshot) {
                                                                                                // Customize what your widget looks like when it's loading.
                                                                                                if (!snapshot.hasData) {
                                                                                                  return Center(
                                                                                                ...
                                                                                                return Row(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Theme(
                                                                                                      ...
                                                                                                      child: Checkbox(
                                                                                                        value: _model.checkboxValueMap4[listViewApplicationsRecord] ??= false,
                                                                                                        onChanged: (newValue) async {
                                                                                                          safeSetState(() => _model.checkboxValueMap4[listViewApplicationsRecord] = newValue!);
                                                                                                        },
                                                                                                        side: BorderSide(
                                                                                                          width: 2,
                                                                                                          color: FlutterFlowTheme.of(context).alternate,
                                                                                          ...
                                                                                          if (responsiveVisibility(
                                                                                            ...
                                                                                            Container(
                                                                                              ...
                                                                                              child: Padding(
                                                                                                ...
                                                                                                child: Text(
                                                                                                  valueOrDefault<String>(
                                                                                                    listViewApplicationsRecord.interviewDate?.toString(),
                                                                                                    'Jan 10, 2025',
                                                                                                  ),
                                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                        fontFamily: 'Aeonik',
                                                                                                ...
                                                                                                if (responsiveVisibility(
                                                                                                  ...
                                                                                                  Builder(
                                                                                                    builder: (context) => InkWell(
                                                                                                      ...
                                                                                                      highlightColor: Colors.transparent,
                                                                                                      onTap: () async {
                                                                                                        logFirebaseEvent('ADMIN_INTERVIEWS_Container_2lgluecf_ON_T');
                                                                                                        await showAlignedDialog(
                                                                                                          context: context,
                                                                                                          isGlobal: false,
                                                                                                          avoidOverflow: false,
                                                                                          ...
                                                                                          StreamBuilder<List<ChatsRecord>>(
                                                                                            ...
                                                                                            builder: (context, snapshot) {
                                                                                              ...
                                                                                              return InkWell(
                                                                                                ...
                                                                                                highlightColor: Colors.transparent,
                                                                                                onTap: () async {
                                                                                                  logFirebaseEvent('ADMIN_INTERVIEWS_Container_zxygbxgc_ON_T');
                                                                                                  _model.addToFriendsList(containerUsersRecord.reference);
                                                                                                  safeSetState(() {});
                                                                                                  _model.addToFriendsList(currentUserReference!);
                                                                                                  safeSetState(() {});
                                                                                                  if (_model.friendsList.length >= 2) {
                                                                                                    if (containerChatsRecord?.reference != null) {
                                                                                                      ...
                                                                                                      // updateChat
                                                                                                      _model.updatedChatThreadintr = await queryChatsRecordOnce(
                                                                                                        singleRecord: true,
                                                                                                      ).then((s) => s.firstOrNull);
                                                                                                      if (Navigator.of(context).canPop()) {
                                                                                                        context.pop();
                                                                                                      ...
                                                                                                      _model.newChatT = ChatsRecord.getDocumentFromData({
                                                                                                        ...createChatsRecordData(
                                                                                                          userA: currentUserReference,
                                                                                                          userB: containerUsersRecord.reference,
                                                                                                          lastMessage: '',
                                                                                    ...
                                                                                    Builder(
                                                                                      builder: (context) => Padding(
                                                                                        ...
                                                                                        child: InkWell(
                                                                                          ...
                                                                                          highlightColor: Colors.transparent,
                                                                                          onTap: () async {
                                                                                            logFirebaseEvent('ADMIN_INTERVIEWS_Icon_g8lec355_ON_TAP');
                                                                                            await showAlignedDialog(
                                                                                              barrierColor: Colors.transparent,
                                                                                              context: context,
                                                                                              isGlobal: false,
