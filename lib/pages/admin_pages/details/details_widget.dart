                                      ...
                                      children: [
                                        if (responsiveVisibility(
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'DETAILS_PAGE_search_rounded_ICN_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'DETAILS_PAGE_Container_0hy9umrt_ON_TAP');
                                            await action_blocks
                                              ...
                                              builder: (context) => Stack(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'DETAILS_PAGE_Container_45z72tpd_ON_TAP');
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'DETAILS_PAGE_Icon_09qwsldp_ON_TAP');
                                                        context.safePop();
                                                      },
                                                      child: Icon(
                                                        Icons.arrow_back,
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '3bv2a4k3' /* Regional Flight Truck Driver */,
                                                          ),
                                                                    ...
                                                                    Flexible(
                                                                      child:
                                                                        ...
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          '76q02mzo' /* Freight Truck (Class A CDL req... */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .labelMedium
                                                                            .override(
                                                              ...
                                                              Flexible(
                                                                child: Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'icrdcag4' /* Monday to Friday: 8AM to 6PM */,
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .labelMedium
