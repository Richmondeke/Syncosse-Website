...
import '/components/jobscard_admin/jobscard_admin_widget.dart';
...
class AdminJobPostingsWidget extends StatefulWidget {
  const AdminJobPostingsWidget({super.key});

  static String routeName = 'Admin_JobPostings';
  static String routePath = 'adminJobPostings';

  @override
  State<AdminJobPostingsWidget> createState() => _AdminJobPostingsWidgetState();
}

class _AdminJobPostingsWidgetState extends State<AdminJobPostingsWidget>
    with TickerProviderStateMixin {
  late AdminJobPostingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminJobPostingsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Admin_JobPostings'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADMIN_JOB_POSTINGS_Admin_JobPostings_ON_');
                              ...
                              builder: (context) => Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'ADMIN_JOB_POSTINGS_PAGE_bg_color_ON_TAP');
                          ...
                          children: [
                                    ...
                                    children: [
                                      if (responsiveVisibility(
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADMIN_JOB_POSTINGS_Icon_1pfe64zj_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADMIN_JOB_POSTINGS_Container_iox9gw6v_ON');
                                            await action_blocks
                                                ...
                                                children: [
                                                  if (responsiveVisibility(
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ADMIN_JOB_POSTINGS_Container_q62fblxp_ON');
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADMIN_JOB_POSTINGS_CREATE_JOB_LISTING_BT');

                                  context.pushNamed(CreateJob1Widget.routeName);
                                },
                                text: FFLocalizations.of(context).getText(
                                  'qca8qt5x' /* Create Job Listing */,
                                ),
                                icon: Icon(
                                  Icons.add,
                                  size: 15.0,
                                ...
                                child: Padding(
                                  ...
                                  child: StreamBuilder<List<JobPostingRecord>>(
                                    stream: queryJobPostingRecord(
                                      queryBuilder: (jobPostingRecord) =>
                                          jobPostingRecord.where(
                                        'postedby',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<JobPostingRecord>
                                          ...
                                          snapshot.data!;
                                      if (gridViewJobPostingRecordList
                                          .isEmpty) {
                                        return EmptyStateSimpleWidget(
                                          ...
                                          title: FFLocalizations.of(context)
                                              .getText(
                                            'jlh0q881' /* No Job Posts Yet */,
                                          ),
                                          body: FFLocalizations.of(context)
                                              .getText(
                                            'obu4ii9u' /* Get started with your first jo... */,
                                          ),
                                        );
                                      }
                                      ...
                                      return GridView.builder(
                                        ...
                                        itemBuilder: (context, gridViewIndex) {
                                          ...
                                          return Container(
                                            ...
                                            child: JobscardAdminWidget(
                                              key: Key(
                                                  'Keyahf_${gridViewIndex}_of_${gridViewJobPostingRecordList.length}'),
                                              jobposting:
                                    ...
                                    child: Padding(
                                      ...
                                      child:
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<JobPostingRecord>
                                              listViewJobPostingRecordList =
                                              snapshot.data!;
                                          if (listViewJobPostingRecordList
                                              .isEmpty) {
                                            return EmptyStateSimpleWidget(
                                              icon: Icon(
                                                Icons.content_paste_sharp,
                                              ...
                                              title: FFLocalizations.of(context)
                                                  .getText(
                                                'ffeyw746' /* There are no Job Listings */,
                                              ),
                                              body: FFLocalizations.of(context)
                                                  .getText(
                                                'd7wjfcjt' /* Get Started by creating a list... */,
                                              ),
                                            );
                                          }
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemBuilder:
                                              ...
                                              final listViewJobPostingRecord =
                                                  listViewJobPostingRecordList[
                                                      listViewIndex];
                                              return Container(
                                                width: double.infinity,
                                                ...
                                                child: JobscardDriverWidget(
                                                  key: Key(
                                                      'Keyqmp_${listViewIndex}_of_${listViewJobPostingRecordList.length}'),
                                                  jobposting:
                                                      listViewJobPostingRecord
                                                          .reference,
                                                  job: listViewJobPostingRecord,
                                                ),
                                              );
                                            },
                                          );
