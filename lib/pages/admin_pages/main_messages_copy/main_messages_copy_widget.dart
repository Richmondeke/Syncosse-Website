...
import 'main_messages_copy_model.dart';
export 'main_messages_copy_model.dart';

class MainMessagesCopyWidget extends StatefulWidget {
  const MainMessagesCopyWidget({
    super.key,
    this.chatRef,
  });
  ...
  static String routeName = 'Main_messagesCopy';
  static String routePath = 'mainMessagesCopy';

  @override
  State<MainMessagesCopyWidget> createState() => _MainMessagesCopyWidgetState();
}

class _MainMessagesCopyWidgetState extends State<MainMessagesCopyWidget>
    with TickerProviderStateMixin {
  late MainMessagesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainMessagesCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_messagesCopy'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MAIN_MESSAGES_COPY_Main_messagesCopy_ON_');
      // addUser_ToList
                              ...
                              builder: (context) => Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'MAIN_MESSAGES_COPY_PAGE_bg_color_ON_TAP');
                                ...
                                children: [
                                  if (responsiveVisibility(
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAIN_MESSAGES_COPY_Icon_h1h98uj4_ON_TAP');
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '3dguwy9p' /* Driver Reference: DRV-28-1381-... */,
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MAIN_MESSAGES_COPY_Container_mf2jikxs_ON');
                                          await action_blocks
                                            ...
                                            builder: (context) => Stack(
                                              ...
                                              children: [
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'MAIN_MESSAGES_COPY_Container_l5c774v9_ON');
                                  ...
                                  if (responsiveVisibility(
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MAIN_MESSAGES_COPY_search_rounded_ICN_ON');
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'MAIN_MESSAGES_COPY_Container_ukmbaid0_ON');
                                                                _model.chat =
                                                                    listmessageswebChatsRecord;
                                                                safeSetState(
                                                                    () {});
                                                                                          ...
                                                                                          children: [
                                                                                            FutureBuilder<List<ChatMessagesRecord>>(
                                                                                              future: queryChatMessagesRecordOnce(
                                                                                                queryBuilder: (chatMessagesRecord) => chatMessagesRecord.where(
                                                                                                  'chat',
                                                                                                  isEqualTo: listmessageswebChatsRecord.reference,
                                                                                                ),
                                                                                                singleRecord: true,
                                                                                              ),
                                                                                              builder: (context, snapshot) {
                                                                                                ...
                                                                                                List<ChatMessagesRecord> containerChatMessagesRecordList = snapshot.data!;
                                                                                                // Return an empty Container when the item does not exist.
                                                                                                if (snapshot.data!.isEmpty) {
                                                                                                  return Container();
                                                                                                }
                                                                                                final containerChatMessagesRecord = containerChatMessagesRecordList.isNotEmpty ? containerChatMessagesRecordList.first : null;
                                                                                            ...
                                                                                            StreamBuilder<List<ChatMessagesRecord>>(
                                                                                              ...
                                                                                              builder: (context, snapshot) {
                                                                                                ...
                                                                                                List<ChatMessagesRecord> textChatMessagesRecordList = snapshot.data!;
                                                                                                // Return an empty Container when the item does not exist.
                                                                                                if (snapshot.data!.isEmpty) {
                                                                                                  return Container();
                                                                                                }
                                                                                                final textChatMessagesRecord = textChatMessagesRecordList.isNotEmpty ? textChatMessagesRecordList.first : null;

                                                                                                return Text(
                                                                                                  valueOrDefault<String>(
                                                                                                    textChatMessagesRecord?.text != null && textChatMessagesRecord?.text != '' ? '1' : '',
                                                                                                    '1',
                                                                                                  ),
                                                                                                  textAlign: TextAlign.start,
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'MAIN_MESSAGES_COPY_Container_n1w2s31c_ON');
