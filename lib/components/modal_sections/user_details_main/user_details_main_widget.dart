                          ...
                          Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'USER_DETAILS_MAIN_Icon_8bhaux81_ON_TAP');
                                  context.safePop();
                                },
                                child: Icon(
                                  Icons.arrow_back,
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'USER_DETAILS_MAIN_Container_l27t4bpb_ON_');
