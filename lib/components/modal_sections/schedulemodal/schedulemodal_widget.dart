...
class SchedulemodalWidget extends StatefulWidget {
  ...
  final UsersRecord? driverprofile;
  final JobPostingRecord? jobPosting;

  /// driverapplication
  final ApplicationsRecord? driverapplication;
...
class _SchedulemodalWidgetState extends State<SchedulemodalWidget>
  ...
  late SchedulemodalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SchedulemodalModel());
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SCHEDULEMODAL_COMP_userList_ON_TAP');
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.selectIndustryValueController ??=
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await widget.driverapplication!.reference
                            ...
                            status: 'Interview',
                            mode: _model.selectIndustryValue,
                            interviewTime: _model.datePicked2,
                            meetingLink: _model.textController1.text,
                          ));
                        },
                        text: FFLocalizations.of(context).getText(
                          'fa4czcz3' /* Schedule Interview */,
                        ),
