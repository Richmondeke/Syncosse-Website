                                  ...
                                  builder: (context) => Container(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      imageUrl: valueOrDefault<String>(
                                        currentUserPhoto,
                                        'https://img.freepik.com/free-photo/sincere-emotions-positive-feelings-concept-happy-pleased-woman-smiles-broadly-keeps-hand-chest-laughs-funny-story-dressed-casual-sweater-isolated-orange-wall_273609-47742.jpg?t=st=1737228418~exp=1737232018~hmac=39f706c5efc39b869a52c49a020a9828c8d438f3e2ee6d9bc11469795d618f3a&w=1380',
                                      ),
                                      fit: BoxFit.fitWidth,
                                    ),
                                  ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await currentUserReference!
                                ...
                                admin: _model.dropDownValue == 'Admin'
                                    ? true
                                    : false,
                              ));
                              if (_model.dropDownValue != null &&
                                  _model.dropDownValue != '') {
                                context.pushNamed(LoginControlWidget.routeName);
                              } else {
                                context.pop();
