...
class DriverWebnavWidget extends StatefulWidget {
  const DriverWebnavWidget({
    super.key,
    this.selectedNav,
  });
  ...
  @override
  State<DriverWebnavWidget> createState() => _DriverWebnavWidgetState();
}

class _DriverWebnavWidgetState extends State<DriverWebnavWidget> {
  late DriverWebnavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverWebnavModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DRIVER_WEBNAV_COMP_bg_color_ON_TAP');
