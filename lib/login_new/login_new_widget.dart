...
class _LoginNewWidgetState extends State<LoginNewWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'LoginNew'});
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '6pcj2lex' /* Enter your details; let’s get ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'LOGIN_NEW_PAGE_PROCEED_BTN_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'LOGIN_NEW_PAGE_RichText_1nh2ealk_ON_TAP');
                                        ...
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              '2gfh8ekk' /* Don't have an account?  */,
                                            ),
                                            style: TextStyle(),
                                          ),
                                          TextSpan(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.asset(
                            'assets/images/Frame_1618869034.png',
                          ).image,
                        ),
